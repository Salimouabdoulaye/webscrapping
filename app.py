...
def main():
    ...
    with tab3:
        ...
        exemples = [
            ...
            ("Commentaire négatif", "Très déçu de cet achat. La qualité n'est pas au rendez-vous, le produit est arrivé cassé et le service client ne répond pas. c'est mauvais comme achat et je le regrette deja"),
        ]
